...
public:
  ...
  /*!
   * \brief tulosta tulostaa päiväyksen parametrina annettuun tulostusvirtaan (kuten cout)
   * \param tulostusvirta, johon tulostetaan
   * \pre -
   */
  void tulosta(std::ostream* tulostusvirta) const;
